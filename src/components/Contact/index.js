    ...
    <section id="reach-out" className="contact">
      ...
      <div className="contact-info">
        <div>
          ...
          <address>
            San Francisco, CA <br />
            P: <a href="tel:789.777.7771">789.777.7771</a>
            <br />
            E:{" "}
            <a href="mailto://snzeribe16@gmail.com">
            snzeribe16@gmail.com
            </a>
          </address>
          <p>
        ...
        <div className="contact-form">
          ...
          <form className="form">
            ...
            />
            <button style={{paddingBottom:'10px', marginBottom:'10px'}} type="button" onClick={handleFormSubmit}>
              Submit
            </button>
          </form>
        </div>
